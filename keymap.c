...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_DOTA] = LAYOUT(_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_LSFT, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_RSFT, KC_SLASH, KC_DOT, KC_BACKSPACE, KC_LALT, _______, _______, _______, _______, _______, _______),
  ...
  [_NUM] = LAYOUT(KC_F12, KC_F1, KC_F2, KC_LEFT_ANGLE_BRACKET, KC_RIGHT_ANGLE_BRACKET, KC_AMPERSAND, KC_SEMICOLON, KC_INS, XXXXXXX, KC_KP_EQUAL, KC_AT, KC_NUM, KC_F11, KC_CIRCUMFLEX, KC_HASH, KC_LEFT_CURLY_BRACE, KC_RIGHT_CURLY_BRACE, KC_DOLLAR, KC_COLON, KC_KP_7, KC_KP_8, KC_KP_9, KC_PERCENT, QK_LOCK, QK_CAPS_WORD_TOGGLE, KC_EXCLAIM, KC_EQUAL, KC_LEFT_PAREN, KC_RIGHT_PAREN, KC_GRAVE, KC_KP_MINUS, KC_KP_4, KC_KP_5, KC_KP_6, KC_KP_PLUS, KC_UNDERSCORE, LSFT_T(PG_LOCK), KC_COLON, KC_PIPE, KC_LEFT_BRACKET, KC_RIGHT_BRACKET, KC_TILDE, _______, _______, KC_KP_SLASH, KC_KP_1, KC_KP_2, KC_KP_3, KC_KP_ASTERISK, RSFT_T(PG_LOCK), QK_BOOT, _______, _______, _______, _______, LT(_NAV, BASE), KC_RSPC, KC_KP_0, KC_KP_DOT, KC_COMMA),
