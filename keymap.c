...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_GAMEPAD] = LAYOUT(XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, JS_L_UP, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, JS_R_UP, XXXXXXX, XXXXXXX, XXXXXXX, _______, XXXXXXX, JS_L_LEFT, JS_L_DOWN, JS_L_RIGHT, XXXXXXX, XXXXXXX, JS_R_LEFT, JS_R_DOWN, JS_R_RIGHT, XXXXXXX, XXXXXXX, LSFT_T(PG_LOCK), XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, RSFT_T(PG_LOCK), XXXXXXX, _______, _______, JS_L_MOD, _______, _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX),
