...
bool achordion_chord(uint16_t tap_hold_keycode, keyrecord_t* tap_hold_record, uint16_t other_keycode, keyrecord_t* other_record) {
  switch (tap_hold_keycode) {
    ...
    case LCTL_T(KC_E):
      ...
      break;
    case RCTL_T(KC_T):
      if (other_keycode == KC_R || other_keycode == KC_Q || other_keycode == KC_W || other_keycode == KC_Z) return true;
      break;
    case RALT_T(KC_S):
